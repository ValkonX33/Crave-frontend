...
import { Restaurant, RestaurnatSearchResponse } from "@/types";
...
export const useGetRestaurant = (restaurantId ?: string) =>{
    ...
    const getRestaurantByIdRequest = async ():Promise<Restaurant>=>{
      ...
      console.log(restaurantId, "restarauntId")
      if(!response.ok){
...
const createSearchRequest = async ():Promise<RestaurnatSearchResponse>  =>{
  ...
  const {data:results, isLoading} = useQuery(["searchRestaurant", searchState], createSearchRequest,
    {enabled:!!city}
  )
